...
| ----- | ---------- | ---------- | ------------------------ |
| `v1.0.0-rc10` | 2026-06-28 | `4c8e5af` | New Inbox **Compact** layout option between Cards and List (#256). The browse-by-tag route's no-collection scope is now labelled "받은함 / Inbox" (was "컬렉션 없음 / No collection"), matching the unified label used everywhere else — the one place the rc9 route slipped (#257). Build = `android-apk.yml` run #120. |
