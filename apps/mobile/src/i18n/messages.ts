...
export const en = {
  ...
  'inbox.cancelSelection': 'Cancel',
  'inbox.cancelSelectionA11y': 'Exit selection mode',
  'inbox.bulkToolbarA11y': 'Bulk actions',
  'inbox.bulkDelete': 'Delete',
  'inbox.bulkDeleteA11y': 'Move selected bookmarks to trash',
  'inbox.bulkDeleteTitle': 'Move to Trash',
  'inbox.bulkDeleteConfirm': {
    one: 'Move 1 bookmark to Trash?',
    other: 'Move {count} bookmarks to Trash?',
  },
  'inbox.bulkMove': 'Move',
  'inbox.bulkMoveA11y': 'Move selected bookmarks to folder',
  'inbox.bulkMoveTitle': {
    one: 'Move 1 bookmark to',
    other: 'Move {count} bookmarks to',
  },
  ...
  'add.memoHint': 'Write in plain text or choose Markdown for formatting.',
  'add.saving': 'Saving…',
  ...
  'toast.trashedCount': {
    one: 'Moved 1 bookmark to Trash',
    other: 'Moved {count} bookmarks to Trash',
  },
  'toast.movedToCollection': {
    one: 'Moved 1 bookmark to {name}',
    other: 'Moved {count} bookmarks to {name}',
  },
  'toast.movedToInbox': {
  ...
  'memo.plain': 'Plain text',
  'memo.markdown': 'Markdown',
  'memo.plainHint': 'Show symbols and line breaks as written.',
  ...
  'detail.memoBodyA11y': 'Memo body',
  'detail.memoBodyPlaceholder': 'Write your memo…',
