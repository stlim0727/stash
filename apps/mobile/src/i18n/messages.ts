...
export const en = {
  ...
  'settings.syncPaused.label': 'Pause sync',
  'settings.syncPaused.on': 'Paused — nothing uploads or pulls until you turn this off',
  'settings.syncPaused.off': 'Uploads and pulls happen automatically',
