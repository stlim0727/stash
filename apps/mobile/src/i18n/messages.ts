...
export const en = {
  ...
  'settings.chat.label': 'Chat with your library',
  'settings.chat.value': 'Ask, save, tag, and organize by chatting',
  'chat.empty': 'Ask me to find, save, or organize your bookmarks.',
  'chat.placeholder': 'Ask about your bookmarks…',
