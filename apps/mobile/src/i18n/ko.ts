...
export const ko: Catalog = {
  ...
  'settings.syncBreakdown.aiSuggestions.label': 'AI 추천',
  'settings.syncBreakdown.aiSuggestions.value': { other: '{count}개' },
  'settings.syncBreakdown.aiSuggestions.valueQuotaReached': {
    other: '{count}개 · 할당량 초과',
  },
  ...
  'settings.aiQueueBacklog.value': { other: '{count}개 · AI 할당량에 맞춰 자동으로 처리돼요' },
