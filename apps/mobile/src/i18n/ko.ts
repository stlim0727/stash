...
export const ko: Catalog = {
  ...
  'settings.chat.label': '라이브러리와 채팅',
  'settings.chat.value': '채팅으로 찾고, 저장하고, 태그하고, 정리하기',
  'chat.empty': '저장한 북마크를 찾거나, 저장하거나, 정리하도록 요청해 보세요.',
  'chat.placeholder': '북마크에 대해 물어보세요…',
  'chat.thinking': '생각 중…',
  'chat.sendA11y': '메시지 보내기',
  'chat.error': '문제가 발생했습니다. 다시 시도해 주세요.',
  'chat.confirm.title': '작업 확인',
  'chat.confirm.approve': '승인',
  'chat.confirm.reject': '거부',
