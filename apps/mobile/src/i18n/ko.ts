...
export const ko: Catalog = {
  ...
  'inbox.searchPlaceholderUncollected': '인박스',
  'inbox.browse': '둘러보기',
  ...
  'inbox.filterAll': '전체',
  'inbox.filterNoCollection': '인박스',
  'inbox.sectionMatches': { other: '검색 결과 {count}개' },
  'inbox.sectionNoCollection': '인박스 · {count}',
  ...
  'inbox.inboxNoCollection': '인박스',
  'inbox.inboxNoCollectionA11y': '인박스 (컬렉션 없음)',
  ...
  'inbox.tagsTitleUncollected': '태그 · 인박스',
  'inbox.tagListCount': '· {count}',
  'inbox.tagsScopedEmpty': '{name}에는 아직 태그가 없습니다.',
  'inbox.tagsUncollectedEmpty': '인박스에 아직 태그가 없습니다.',
