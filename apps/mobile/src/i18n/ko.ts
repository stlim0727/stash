...
export const ko: Catalog = {
  ...
  'detail.memoBodyA11y': 'Markdown 메모 내용',
  'detail.memoBodyPlaceholder': 'Markdown으로 메모를 작성하세요…',
