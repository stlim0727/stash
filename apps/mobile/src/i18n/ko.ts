...
export const ko: Catalog = {
  ...
  'settings.diagnostics.footnote':
    '위 raw 수치는 각 파이프라인의 원시 todo/done 개수로, 위 활동 상태 섹션의 통합 수치와 다를 수 있어요.',
  ...
  'settings.diagnostics.pipelineSync.label': '파이프라인: 동기화 (대기/완료)',
  'settings.diagnostics.pipelineSync.value': '{todo} / {done} (1회: {once}, 2회: {twice})',
  'settings.diagnostics.pipelineMetadata.label': '파이프라인: 메타데이터 (대기/완료)',
  'settings.diagnostics.pipelineMetadata.value': '{todo} / {done}',
  'settings.diagnostics.pipelineAi.label': '파이프라인: AI 추천 (대기/완료)',
