...
export const ko: Catalog = {
  ...
  'graph.buildingStageDerive': '북마크를 불러오는 중…',
  'graph.buildingStageLayout': '노드를 배치하는 중…',
  'graph.buildingStagePlacing': '북마크를 정리하는 중…',
  'graph.buildingStageDeclutter': '레이아웃을 다듬는 중…',
  ...
  'inbox.searchPlaceholder': '제목·태그·컬렉션 검색',
  'inbox.searchPlaceholderScoped': '{name}에서 검색',
  'inbox.searchPlaceholderUncollected': '미분류',
  'inbox.browse': '둘러보기',
  ...
  'inbox.folderSortNameAsc': '이름 ㄱ–ㅎ',
  'inbox.folderSortNameDesc': '이름 ㅎ–ㄱ',
  'inbox.folderSortCountDesc': '항목 많은 순',
  'inbox.folderSortCountAsc': '항목 적은 순',
  ...
  'inbox.filterAll': '전체',
  'inbox.filterNoCollection': '미분류',
  'inbox.sectionMatches': { other: '검색 결과 {count}개' },
  'inbox.sectionNoCollection': '미분류 · {count}',
  ...
  'inbox.inboxNoCollectionA11y': '미분류 (컬렉션 없음)',
  'inbox.collectionTileCount': { other: '{count}개 항목' },
  'inbox.newCollection': '새 컬렉션',
  'inbox.newCollectionA11y': '새 컬렉션 만들기',
  'inbox.newCollectionNamePlaceholder': '컬렉션 이름',
  'inbox.newCollectionCreate': '만들기',
  ...
  'inbox.tagsTitleUncollected': '태그 · 미분류',
  'inbox.tagListCount': '· {count}',
  'inbox.tagsScopedEmpty': '{name}에는 아직 태그가 없습니다.',
  'inbox.tagsUncollectedEmpty': '미분류에 아직 태그가 없습니다.',
  ...
  'search.collectionChipA11y': '{name} 컬렉션 보기',
  ...
  'viewMode.list': '목록',
  'viewMode.collection': '컬렉션',

  'add.urlLabel': 'URL (선택)',
  'add.urlPlaceholder': 'https://',
  'add.modeLink': '링크',
  'add.modeMemo': '메모',
  'add.modeLinkA11y': '링크 북마크 추가',
  'add.modeMemoA11y': '메모 추가',
  'add.noteLabel': '메모 (선택)',
  'add.notePlaceholder': '왜 저장하나요?',
  'add.memoTitleLabel': '제목 (선택)',
  'add.memoTitlePlaceholder': '메모 제목을 입력하세요',
  'add.memoBodyLabel': '메모',
  'add.memoBodyPlaceholder': '메모를 작성하세요…',
  'add.memoRequired': '메모 내용을 입력해 주세요.',
  'add.urlOrMemoRequired': '웹 주소를 입력하거나 메모를 작성해 주세요.',
  'add.save': '북마크 저장',
  'add.saveMemo': '메모 저장',
  'add.hint': '즉시 저장됩니다. 동기화는 백그라운드에서 진행됩니다.',
  'add.memoHint': '일반 텍스트로 작성하거나 Markdown으로 서식을 넣을 수 있어요.',
  'add.saving': '저장 중…',
  ...
  'settings.section.help': '도움말 및 가이드',
  'settings.tutorial.label': '기능 가이드',
  'settings.tutorial.value': 'Keepory 둘러보기',
  ...
  'settings.sync.paused': '일시 정지됨',
  'settings.sync.pausedWaiting': { other: '일시 정지됨 — {count}개 항목 대기 중' },
  'settings.sync.waiting': { other: '{count}개 항목 업로드 대기 중' },
  'settings.sync.pauseButton': '동기화 일시 정지',
  'settings.sync.resumeButton': '동기화 재개',
  'settings.processing.label': '백그라운드 처리',
  'settings.processing.complete': '모든 작업 완료',
  'settings.processing.remaining': { other: '{count}개 남음' },
  'settings.processing.remainingWithAttention': {
    other: '{count}개 남음 · {attention}개 확인 필요',
  },
  'settings.processing.count': { other: '{count}개' },
  'settings.processing.cloud.label': '클라우드 저장',
  'settings.processing.cloud.localOnly': '{count}개 · 로컬 전용',
  'settings.processing.cloud.paused': '{count}개 · 동기화 일시 정지',
  'settings.processing.cloud.syncing': '{count}개 · 저장 중',
  'settings.processing.metadata.label': '정보 가져오기',
  'settings.processing.ai.label': 'AI 추천 준비',
  'settings.processing.ai.off': '{count}개 · AI 추천 꺼짐',
  'settings.processing.ai.localPaused': '{count}개 · 로컬 AI 대기',
  'settings.processing.ai.quota': '{count}개 · {resetTime}에 재개',
  'settings.processing.attention.label': '확인 필요',
  'settings.processing.details.label': '처리 상세',
  'settings.processing.details.show': '진단 카운터 보기',
  'settings.processing.details.hide': '진단 카운터 숨기기',
  'settings.processing.details.none': '없음',
  'settings.processing.details.syncStates.label': '클라우드 큐 상태',
  'settings.processing.details.syncStates.value':
    '대기 {pending} · 처리 중 {syncing} · 실패 {failed}',
  'settings.processing.details.syncOps.label': '클라우드 큐 작업',
  'settings.processing.details.syncOps.value':
    '생성 {create} · 수정 {update} · 삭제 {delete}',
  'settings.processing.details.syncHealth.label': '클라우드 큐 상태 점검',
  'settings.processing.details.syncHealth.value':
    '최대 재시도 {retries} · 가장 오래된 작업 {oldest}',
  'settings.processing.details.metadata.label': '정보 수집 파이프라인',
  'settings.processing.details.metadata.value':
    '대기 {pending} · 실패 {failed} · 건너뜀 {skipped}',
  'settings.processing.details.aiLocal.label': 'AI 로컬 파이프라인',
  'settings.processing.details.aiLocal.value':
    '트리거 {trigger} · 전송 대기 {dispatch} · 재시도 {retry} · 처리 중 {active}',
  'settings.processing.details.aiServer.label': 'AI 서버 파이프라인',
  'settings.processing.details.aiServer.value':
    '대기 {pending} · 처리 중 {processing} · 실패 {failed}',
  'settings.processing.details.degraded.label': '기본 제안 표시',
  'settings.processing.details.degraded.value': '사용량 제한 {count}개',
  ...
  'settings.activity.aiSuggestions.label': 'AI 추천',
  'settings.activity.aiSuggestions.value': { other: '{count}개' },
  'settings.activity.aiSuggestions.blockedOff': {
    other: '{count}개 · AI 추천이 꺼져 있어요 — 대기 중이던 항목만 계속 처리돼요',
  },
  'settings.activity.aiSuggestions.blockedPaused': {
    other: '{count}개 · 동기화가 일시 정지돼 있어요 — 재개하면 계속 처리돼요',
  },
  ...
  'settings.developer.value': '진단 및 빌드 정보',
  'settings.language.label': '언어',
  'settings.language.system': '시스템 기본값',
  'settings.language.en': 'English',
  'settings.language.ko': '한국어',
  'settings.language.sheetTitle': '앱 언어',
  'settings.aiSuggestions.label': 'AI 추천',
  'settings.aiSuggestions.sheetTitle': 'AI 추천 모드',
  ...
  'settings.pushNotifications.deniedBody':
    '알림 권한이 없어 이 알림을 보낼 수 없어요. 기기 설정에서 Stash 알림을 허용한 뒤 다시 시도해주세요.',
  'settings.pushNotifications.unavailableTitle': '지금은 알림을 켤 수 없어요',
  'settings.pushNotifications.unavailableBody': '이 기기에서 알림을 설정하는 중 문제가 발생했어요. 나중에 다시 시도해주세요.',
  'settings.diagnostics.title': '진단',
  'settings.diagnostics.footnote':
    '백그라운드 파이프라인의 실시간 원시 수치예요 — 동기화나 AI 추천이 멈춘 것 같을 때 확인하세요.',
  ...
  'settings.diagnostics.recentPulls.label': '최근 가져오기',
  'settings.diagnostics.recentPulls.none': '아직 없음',
  'settings.diagnostics.recentPulls.entryLabel': '{index}번째 시도',
  'settings.diagnostics.recentPulls.rows': {
    other: '{count}개',
  },
  'settings.diagnostics.recentPulls.success': '{time} · {rows}',
  'settings.diagnostics.recentPulls.failure': '{time} · 실패: {error}',
  'settings.diagnostics.syncLifecycle.label': '동기화 이력 (1회/2회 이상)',
  'settings.diagnostics.syncLifecycle.value': '{once} / {twice}',
  'settings.diagnostics.metadataDone.label': '메타데이터 완료 개수',
  'settings.diagnostics.metadataDone.value': '{done}',
  'settings.diagnostics.aiDone.label': 'AI 추천 완료 개수',
  ...
  'settings.exportSheet.jsonDescription': 'AI 요약·태그·신뢰도까지 모두 포함',
  'settings.exportSheet.share': '공유…',
  'settings.exportSheet.saveToDevice': '기기에 저장',
  ...
  'settings.export.savedTitle': '내보내기 저장 완료',
  ...
  'memo.plainHint': '기호와 줄바꿈을 입력 그대로 표시해요.',
  ...
  'memo.write': '작성',
  'memo.preview': '미리보기',
  'detail.memoFallbackTitle': '메모',
  'detail.memoContentLabel': '내용',
  'detail.memoPreview': '미리보기',
  'detail.memoEdit': 'Markdown 편집',
  'detail.memoBodyA11y': '메모 내용',
  'detail.memoBodyPlaceholder': '메모를 작성하세요…',
  ...
  'detail.suggestedCollectionLabel': '제안된 컬렉션',
  ...
  'review.createCollectionChip': '📁 ＋ “{name}” 만들기',
  'review.collectionAddArrow': '📁 → {name}',
  'review.collectionCreateArrow': '📁 ＋ “{name}” 만들기',
  'review.moveArrowTarget': '→ {name}',
  'review.moveCreateTarget': '→ ＋ “{name}”',
  'review.acceptCollectionA11y': '{title}을(를) {name}에 정리',
  'review.createCollectionA11y': '컬렉션 {name}을(를) 만들고 {title} 정리',
  'review.moveCollectionA11y': '{title}을(를) {from}에서 {name}(으)로 이동',
  'review.moveCreateCollectionA11y': '{title}을(를) {from}에서 새 컬렉션 {name}(으)로 이동',
  'review.dismissCollectionA11y': '{title}의 제안된 컬렉션 {name} 무시',
  ...
  'report.contextPreviewToggleA11y': '진단 컨텍스트 미리보기 열기 또는 닫기',
  'report.showDiagnostics': '진단 컨텍스트 보기',
  ...
  'tutorial.title': 'Keepory 둘러보기',
  'tutorial.closeA11y': '튜토리얼 닫기',
  'tutorial.stepIndicator': '{total}단계 중 {current}단계',
  'tutorial.skip': '건너뛰기',
  'tutorial.back': '이전',
  'tutorial.next': '다음',
  'tutorial.getStarted': '시작하기',
  'tutorial.step1.badge': '순식간에 캡처',
  'tutorial.step1.title': '하던 일을 멈추지 않고 바로 저장',
  'tutorial.step1.body':
    '읽고 있던 아티클, 영상, SNS 글에서 공유하기를 누르고 Keepory를 선택하세요. 화면을 벗어나지 않고 백그라운드에서 즉시 안전하게 저장됩니다.',
  'tutorial.step1.point1': '어떤 앱에서든 원탭 OS 공유 지원',
  'tutorial.step1.point2': '링크 없는 간단한 생각과 메모도 저장',
  'tutorial.step1.point3': '오프라인에서도 즉시 작동하는 로컬 우선 저장',
  'tutorial.step2.badge': '스마트 인박스',
  'tutorial.step2.title': '원하는 방식으로 보고, 1초 만에 찾기',
  'tutorial.step2.body':
    '풍부한 카드 뷰와 깔끔한 리스트 뷰를 자유롭게 전환하세요. 열기 ↗ 버튼으로 웹사이트를 즉시 열고, 실시간 검색으로 원하는 링크를 바로 찾을 수 있습니다.',
  'tutorial.step2.point1': '카드 뷰와 리스트 뷰 자유로운 전환',
  'tutorial.step2.point2': '추가 탭 없이 바로 브라우저로 이동하는 “열기 ↗”',
  'tutorial.step2.point3': '제목, 태그, 도메인까지 실시간 하이라이트 검색',
  'tutorial.step3.badge': 'AI 추천과 검토',
  'tutorial.step3.title': '태그 고민 끝, AI가 정리해 드립니다',
  'tutorial.step3.body':
    '저장할 때마다 폴더와 태그를 고민할 필요가 없습니다. Keepory가 링크를 분석해 태그, 폴더, 요약을 제안하며, 검토 화면에서 한 번에 승인할 수 있습니다.',
  'tutorial.step3.point1': '스마트 태그, 추천 폴더, 자동 요약 생성',
  'tutorial.step3.point2': '직접 작성한 내용은 유지되는 비파괴적 제안 방식',
  'tutorial.step3.point3': '검토 화면에서 탭 한 번으로 일괄 승인',
  'tutorial.step4.badge': '지식 그래프',
  'tutorial.step4.title': '내 관심사가 어떻게 이어지는지 확인',
  'tutorial.step4.body':
    '북마크를 폴더 깊숙이 묻어두지 마세요. 상단 그래프 아이콘을 탭하면 저장한 콘텐츠들이 태그와 주제를 통해 유기적으로 연결되는 모습을 한눈에 볼 수 있습니다.',
  'tutorial.step4.point1': '북마크와 태그의 인터랙티브 시각화 지도',
  'tutorial.step4.point2': '북마크 연결 모드와 태그 클러스터 모드 제공',
  'tutorial.step4.point3': '이동, 확대/축소로 숨겨진 연관성 발견',
};
