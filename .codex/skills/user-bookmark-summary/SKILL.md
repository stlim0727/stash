...
Use the Supabase app tools exposed in Codex. There is a single project; discover
its id rather than hardcoding:

1. `mcp__codex_apps__supabase._list_projects` → take the `id` (currently
...
`mcp__codex_apps__supabase._execute_sql` with the project id and exactly this query. It
