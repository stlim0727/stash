...
- [Use cases (visual)](docs/design/use-cases.md) — diagrammed end-to-end flows
- [Screen gallery](docs/design/ux-spec.md#screens) — screenshots of every screen
- [UX spec and status checklist](docs/design/ux-spec.md)
